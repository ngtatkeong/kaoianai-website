          ...
          <div className="relative z-10">
            ...
            <div className="grid sm:grid-cols-3 gap-5">
              ...
              <div className="p-5 rounded-2xl bg-slate-50 border border-slate-200/80">
                ...
                <h4 className="font-bold text-gray-900 text-base mb-1">1-Click Statutory RoPA Export</h4>
                <p className="text-xs sm:text-sm text-gray-600 leading-relaxed">
                  Export auditable Singapore PDPA, MAS TRM, and GDPR Article 30 Records of Processing Activities (RoPA) backed by mathematical schema proof.
                </p>
              </div>
            </div>
          </div>
